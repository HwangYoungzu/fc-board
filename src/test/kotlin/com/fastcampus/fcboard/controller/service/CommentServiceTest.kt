...
class CommentServiceTest(
    ...
    given("댓글 생성시") {
        postRepository.save(Post(title = "게시글 재목", content = "게시글 내용", createdBy = "게시글 작성자"))
        When("인풋이 정상적으로 들어오면") {
    ...
    given("댓글 수정시") {
        val post = postRepository.save(Post(title = "게시글 재목", content = "게시글 내용", createdBy = "게시글 작성자"))
